...
evaluation7 = Dailyevaluation.create!( { evaluation: "bad", date: "2017/10/10", remark: "The student is bad.", student: student9 } )
evaluation8 = Dailyevaluation.create!( { evaluation: "excellent", date: "2017/10/10", remark: "The student is excellent.", student: student10 } )
evaluation9 = Dailyevaluation.create!( { evaluation: "good", date: "2017/10/10", remark: "The student is goog, need improve.", student: student11 } )
evaluation10 = Dailyevaluation.create!( { evaluation: "excellent", date: "2017/10/10", remark: "The student is excellent.", student: student12 } )
